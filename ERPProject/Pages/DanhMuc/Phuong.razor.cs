...
{
    public class PhuongBase : ComponentBase
    {
        public List<prc_phuong> listPrcPhuong { get; set; }

        protected Phuong_CapNhat fCapNhat;
        ...
        protected SfGrid<prc_phuong> gdv;
        ...
        protected async void onTaiLai()
        {
            ...
            var rsModel = new ResultModel<List<prc_phuong>>();
            await Task.Run(() => { rsModel = phuongService.GetAll_prc_phuong(); });
            if (rsModel.isThanhCong)
            {
                listPrcPhuong = rsModel.Data;
        ...
        protected void onXoa(int _ID)
        {
            ...
            frmXacNhan.Show("Xóa dòng được chọn ?", "300px", new System.Action(async () =>
            {
                ...
                await Task.Run(() => { rsModel = phuongService.DeleteById(_ID); });
                AppData.loadingPanel.hide();
        ...
        public async Task onXuatExcel()
        {
            ...
            excelExportProperties.FileName = "Danh sach phuong.xlsx";
            ...
            {
                excelExportProperties.DataSource = listPrcPhuong;
            }
