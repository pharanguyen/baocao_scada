...
{
    public class Kieu_TToanBase : ComponentBase
    {
        public List<kieu_ttoan> listKieu_TToan { get; set; }
        protected Kieu_TToan_CapNhat fCapNhat;
        ...
        protected SfGrid<kieu_ttoan> gdv;
            ...
            Task.Run(() =>
            {
                InvokeAsync(async () =>
                {
                    ...
                    if (strInfo.Length == 5)
                    {
                        ...
                        await Task.Run(() => { rsModel = ds_phanquyenService.GetQuyenThanhVien(Convert.ToInt32(strInfo[0]), "mnuDM_Kieuthanhtoan"); });
                        _QSD = rsModel.Data;
        ...
        protected async void onTaiLai()
        {
            ...
            var rsModel = new ResultModel<List<kieu_ttoan>>();
            await Task.Run(() => { rsModel = kieu_ttoanService.GetAll(); });
            if (rsModel.isThanhCong)
            {
                listKieu_TToan = rsModel.Data;
        ...
        protected void onXoa(int _ID)
        {
            ...
            frmXacNhan.Show("Xóa dòng được chọn ?", "300px", new System.Action(async () =>
            {
                ...
                await Task.Run(() => { rsModel = kieu_ttoanService.DeleteById(_ID); });
                AppData.loadingPanel.hide();
        ...
        public async Task onXuatExcel()
        {
            ...
            excelExportProperties.FileName = "Danh sach kieu thanh toan.xlsx";
            ...
            {
                excelExportProperties.DataSource = listKieu_TToan;
            }
