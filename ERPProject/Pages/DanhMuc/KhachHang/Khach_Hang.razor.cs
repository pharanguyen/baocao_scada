...
{
    public class Khach_HangBase : ComponentBase
    {
        public List<prc_khach_hang> listPrcKhachHang { get; set; }

        protected Khach_Hang_CapNhat fCapNhat;
        ...
        protected SfGrid<prc_khach_hang> gdv;
        ...
        protected void onXoa(int _ID)
        {
            ...
            frmXacNhan.Show("Xóa dòng được chọn ?", "300px", new System.Action(async () =>
            {
                ...
                await Task.Run(() => { rsModel = khach_hangService.DeleteById(_ID); });
        ...
        protected async void onTaiLai()
        {
            ...
            AppData.loadingPanel.show();
            var rsModel = new ResultModel<List<prc_khach_hang>>();
            await Task.Run(() => { rsModel = khach_hangService.GetAll_prc_khach_hang(); });
            if (rsModel.isThanhCong)
            {
                listPrcKhachHang = rsModel.Data;
                AppData.loadingPanel.hide();
            }
            else
            {
        ...
        public async Task onXuatExcel()
        {
            ...
            excelExportProperties.FileName = "Danh sach khach hang.xlsx";
            ...
            {
                excelExportProperties.DataSource = listPrcKhachHang;
            }
